...
中心化的 GPU 推断模块, <a href="#" id="SeedRL"> SeedRL </a>

multi-teacher policy distillation. [策略蒸馏方法](Policy distillation)
...
多头值函数, 混合奖励[Hybrid reward architecture for reinforcement learning]()
